...
(function() {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '#yves-panel-header .name { font-weight: 700; color: white; font-size: 14px; font-family: "Space Grotesk", sans-serif; }',
      '#yves-panel-header .status { font-size: 11px; color: #10b981; }',
      ...
      '#yves-messages .yves-msg { background: rgba(139,92,246,0.08); border: 1px solid rgba(139,92,246,0.12); border-radius: 14px; border-top-left-radius: 4px; padding: 10px 14px; font-size: 13px; color: #cbd5e1; line-height: 1.5; max-width: 90%; }',
      '#yves-messages .user-msg { background: rgba(139,92,246,0.15); border: 1px solid rgba(139,92,246,0.2); border-radius: 14px; border-top-right-radius: 4px; padding: 10px 14px; font-size: 13px; color: white; align-self: flex-end; max-width: 85%; }',
      ...
      '.yves-sug-btn { background: rgba(139,92,246,0.1); border: 1px solid rgba(139,92,246,0.2); border-radius: 20px; padding: 6px 12px; font-size: 12px; color: #a78bfa; cursor: pointer; transition: all 0.2s; font-family: inherit; }',
      ...
      '#yves-input { flex: 1; background: #05050a; border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 10px 14px; color: white; font-size: 13px; font-family: inherit; outline: none; resize: none; }',
